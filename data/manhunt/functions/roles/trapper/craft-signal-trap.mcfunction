...
kill @e[type=item,nbt={Item:{id:"minecraft:stick",Count:3b}},sort=nearest,limit=1]
kill @e[type=item,nbt={Item:{id:"minecraft:iron_ingot",Count:1b}},sort=nearest,limit=1]
